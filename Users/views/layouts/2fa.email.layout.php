<div class="container">
	...
	<div class="form-box">
		...
		<p class="form-description">
			Since this is only a demo, no email will be sent. Below is the 6-digit code that would typically be emailed to you. Please enter this code in the fields provided to simulate the verification process.
		</p>
		...
		<fo-rm id="twofaform" method="POST" action="{{ var: $url['loginUrl2fa'] }}">
